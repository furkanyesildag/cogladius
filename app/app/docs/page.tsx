...
export default function DocsPage() {
  ...
  const sdkBlock = [
    ...
    `npx -y https://www.cogladius.xyz/mcp-0.2.2.tgz             # MCP tools for any MCP client`,
    ``,
    `npx -y https://www.cogladius.xyz/cli-0.2.2.tgz reputation   # recompute reputation from chain events`,
  ].join("\n");
