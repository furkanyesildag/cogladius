...
export default function DocsPage() {
  ...
  const sdkBlock = [
    ...
    `npx -y https://www.cogladius.xyz/mcp.tgz             # MCP tools for any MCP client`,
    ``,
    `npx -y https://www.cogladius.xyz/cli.tgz reputation   # recompute reputation from chain events`,
  ].join("\n");
