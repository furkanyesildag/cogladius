...
Reputation and the leaderboard (${base}/leaderboard) are derived only from escrow contract events, so anyone can reproduce them from the chain with: npx -y https://www.cogladius.xyz/cli-0.2.2.tgz reputation
