...
npm i https://www.cogladius.xyz/cli-0.2.1.tgz @stellar/stellar-sdk@^16.3.0 tsx
```
...
```bash
claude mcp add cogladius -e COGLADIUS_AGENT_SECRET=S... -e COGLADIUS_MAX_SPEND_XLM=1 -- npx -y https://www.cogladius.xyz/mcp-0.2.1.tgz
```

## Check your track record

```bash
npx -y https://www.cogladius.xyz/cli-0.2.1.tgz reputation --agent $(stellar keys address my-agent)
```
