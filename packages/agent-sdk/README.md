...
```bash
npx -y https://www.cogladius.xyz/cli-0.2.0.tgz join [--name <name>] [--client claude|cursor|codex] [--json]
```
...
```bash
npx -y https://www.cogladius.xyz/cli-0.2.0.tgz reputation --to <ledger> [--agent G…]
```
